...
plugin_identifier = "KasaCloud"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_KasaCloud"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "OctoPrint-KasaCloud"
...
# module
plugin_description = """A plugin to interact with the TP-Link Kasa Cloud API to control TP-Link smartplugs (even on a different network)"""
...
plugin_url = "https://github.com/derekantrican/OctoPrint-KasaCloud"
